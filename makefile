# Project
PROJECT = PointCloud
PROJECT_BRIEF = Identify huamans in a point cloud.

#### Specify here external library dependencies as compiler flags

EXT_INCLUDE = 
EXT_LDFLAGS = 
EXT_LDFLAGS += $(shell root-config --ldflags) $(shell root-config --libs) -lTMVA
EXT_CXXFLAGS = 
...
#### Specify here type of outputs: share, static, exec or doc
all : exec 
	@echo "All OK"
####
